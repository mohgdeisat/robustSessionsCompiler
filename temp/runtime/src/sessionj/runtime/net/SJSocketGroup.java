...
public class SJSocketGroup implements SJSocket, Serializable
{
    ...
    public void send(String p, Object o, boolean b, Exception ex) throws SJIOException
    {
	if(b)
	    send(p, o);
	else
    ...
    public void pass(String p, Object o, boolean condition, Exception ex) throws SJIOException
    {
	if(condition)
	    pass(p, o);
	else
