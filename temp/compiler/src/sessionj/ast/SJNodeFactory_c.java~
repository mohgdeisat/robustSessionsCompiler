...
public class SJNodeFactory_c extends NodeFactory_c implements SJNodeFactory 
{
    ...
    public SJPTryNode SJPTryNode(Position pos, SJTypeNode body, List<SJPCatchNode> catchNodes) {
	return new SJPTryNode_c(pos, body, catchNodes);
    }
    
    public SJPCatchNode SJPCatchNode(Position pos, SJTypeNode body, TypeNode exceptionType) {
    	return new SJPCatchNode_c(pos, body, exceptionType);
    }

    public SJPTry SJPTry(Position pos, Block tryBlock, List catches) {
	return new SJPTry_c(pos, tryBlock, catches, null);
    }

    // SJPCatch SJPCatch(Position pos, TypeNode exceptionType, Block catchBlock) {
    // 	return null;
    // }
