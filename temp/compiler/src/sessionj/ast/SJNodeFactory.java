...
public interface SJNodeFactory extends NodeFactory 
{
    ...
    //</By MQ>
    //<By MQ>
    SJPTryNode SJPTryNode(Position pos, SJTypeNode body, List<SJPCatchNode> catchNodes);
    SJPCatchNode SJPCatchNode(Position pos, SJTypeNode body, TypeNode exceptionType);
    SJPTry SJPTry(Position pos, Block tryBlock, List catches);
