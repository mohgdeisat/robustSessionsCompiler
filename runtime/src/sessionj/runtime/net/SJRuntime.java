...
public class SJRuntime
{
    ...
    public static void send(Object obj, String p, boolean b, Exception ex, SJSocket s) throws SJIOException
	{
	    if(s instanceof SJSocketGroup)
		((SJSocketGroup)s).send(p, obj, b, ex);
	    else
		s.send(obj);
	}
    ...
    public static void send(Object obj, String p, boolean b, Exception ex, SJSocket... sockets) throws SJIOException 
	{
		for (SJSocket s : sockets)
		{
		    if(s instanceof SJSocketGroup)
    ...
    public static void pass(Object obj, String p, boolean b, Exception ex, SJSocket s) throws SJIOException, Exception
	{
	    if(s instanceof SJSocketGroup)
		((SJSocketGroup)s).pass(p, obj, b, ex);
	    else
		s.pass(obj);            
	    if(b == false)
		throw(ex);
    ...
    public static void pass(Object obj, String p, boolean b, Exception ex, SJSocket... sockets) throws SJIOException
	{
	    for (SJSocket s : sockets)
		{
		    if(s instanceof SJSocketGroup)
 ...
 //<By MQ> Changed all receive methods to support multi-party
    public static Object receive(String p, SJSocket s) throws SJIOException, ClassNotFoundException, Exception // Remove array in a compiler pass.
	{
	    s.flush(); //<By MQ>
	    Object o;
	    if(s instanceof SJSocketGroup)
		o = ((SJSocketGroup) s).receive(p);
	    else
		o = s.receive();
